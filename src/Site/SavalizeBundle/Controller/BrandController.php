...
use Site\SavalizeBundle\Form\BrandType;
...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SiteSavalizeBundle:Brand')->findAll();

        return $this->render('SiteSavalizeBundle:Brand:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SiteSavalizeBundle:Brand:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SiteSavalizeBundle:Brand')->find($id);
        ...
        return $this->render('SiteSavalizeBundle:Brand:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SiteSavalizeBundle:Brand:edit.html.twig', array(
            'entity'      => $entity,
