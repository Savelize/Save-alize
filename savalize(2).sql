...
--
-- Host: localhost
-- Generation Time: Jun 08, 2013 at 12:23 AM
...
CREATE TABLE IF NOT EXISTS `product_rating` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`product_id`,`brand_id`),
...
ALTER TABLE `product_rating`
  ADD CONSTRAINT `product_rating_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `product_rating_ibfk_2` FOREIGN KEY (`brand_id`) REFERENCES `brand` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `product_rating_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user_account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
